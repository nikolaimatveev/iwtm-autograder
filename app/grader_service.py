...
class GraderService:
    ...
    def check_events_normal_mode(self, grouped_events, iwtm_policies):
        ...
        1. Выполнить максимальную проверку, в результате которой в структуру
        grouped_events будет занесена разница событий и статистика по
        различным недочетам;
        2. Обнулить недочеты, относящиеся к ложным срабатываниям
        3. Для каждой политики и объекта найти ложные срабатывания и
        занести их в статистику
        '''
